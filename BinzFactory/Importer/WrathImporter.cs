...
public class WrathImporter(string gamePath, string dataFolder) : OwlcatGame("Wrath", gamePath, dataFolder, "Assembly-CSharp.dll", "Kingmaker.Blueprints.JsonSystem.TypeIdAttribute")
{
