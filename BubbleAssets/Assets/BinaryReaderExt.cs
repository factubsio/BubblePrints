...
namespace WikiGen.Assets
{
    ...
    {
        public static BasedStream Based(this Stream stream, long offset, long length) => new(stream, offset, length);
        public static BasedStream Based(this Stream stream, ObjectInfo info) => new(stream, info.byteStart, info.byteSize);
        ...
        {
            var arr = reader.ReadSingleArray(16);
            return new Matrix4x4(arr[0], arr[1], arr[2], arr[3], arr[4], arr[5], arr[6], arr[7],
