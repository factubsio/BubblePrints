...
namespace WikiGen.Assets
{
    ...
    public sealed class Texture2D : AssetObject
    {
        ...
        public Texture2D(AssetFileReader reader) : base(reader.File)
        {
            ...
            if (version.Major < 5 || version.Major == 5 && version.Minor < 2) //5.2 down
            {
            ...
            if (version.Major > 2 || version.Major == 2 && version.Minor >= 6) //2.6.0 and up
            {
            ...
            if (version.Major > 2019 || version.Major == 2019 && version.Minor >= 3) //2019.3 and up
            {
            ...
            if (version.Major > 2018 || version.Major == 2018 && version.Minor >= 2) //2018.2 and up
            {
            ...
            if (version.Major > 3 || version.Major == 3 && version.Minor >= 5) //3.5.0 and up
            {
